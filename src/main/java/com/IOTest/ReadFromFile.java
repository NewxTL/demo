...
/**
 * Created by Newx on 2017/8/15.
 */
public class ReadFromFile {

    public static void main(String[] args) {
        // TODO Auto-generated method stub
        String fileName = "C:/Users/Newx/Desktop/test.txt";
...
//        readFileByRandomAccess(fileName);
    ...
    public static void readFileByLines(String fileName) {
        ...
        try {
            ...
            while ((tempString = reader.readLine()) != null) {
                ...
                String temp = tempString.replace("|",",");
                String[] tempArray = temp.split(",");
                List list = new ArrayList<>();
                Collections.addAll(list, tempArray);
                if (StringUtils.isNotBlank(tempString)) {
                    if (line == 1) {
                        stringArray1 = tempArray;
                    }
                    for (int i = 0; i < stringArray1.length; i++) {
                        System.out.println(stringArray1[i] + "  :  " + tempArray[i]);
                    }
                }
                line++;
            }
     ...
     * @return
     */
    private static BufferedReader transCode(File file,String encode){
